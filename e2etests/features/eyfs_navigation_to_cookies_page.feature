Feature: EYFS - Navigation to Cookie page
  ...
  Scenario:  Get help to improve your practice - Cookie link navigation
    ...
    When user proceeds to "Communication and language" page
    And clicks on "Get help to improve your practice"
    And clicks on "Cookies"
    Then page has heading "Cookies"
  ...
  Scenario:  Get help to improve your practice - Curriculum Planning - Cookie link navigation
    ...
    When user proceeds to "Physical development" page
    And clicks on "Get help to improve your practice"
    And clicks on "Curriculum planning"
    And clicks on "Cookies"
    Then page has heading "Cookies"
  ...
  Scenario:  Get help to improve your practice - Reducing Paperwork - Cookie link navigation
    ...
    When user proceeds to "Personal, social and emotional development" page
    And clicks on "Get help to improve your practice"
    And clicks on "Reducing paperwork"
    And clicks on "Cookies"
    Then page has heading "Cookies"
...
#    When user proceeds to "Literacy" page
#    And clicks on "Get help to improve your practice"
#    And clicks on "Identifying and supporting children with special educational needs and disabilities (SEND)"
#    And clicks on "Cookies"
#    Then page has heading "Cookies"
  ...
  Scenario:  Get help to improve your practice - Working in partnership with Parents and Carers - Cookie link navigation
    ...
    When user proceeds to "Understanding the world" page
    And clicks on "Get help to improve your practice"
    And clicks on "Working in partnership with parents and carers"
    And clicks on "Cookies"
    Then page has heading "Cookies"
