...
ActiveRecord::Schema.define(version: 2021_06_16_134257) do
  ...
  create_table "content_assets", force: :cascade do |t|
    ...
    t.integer "site_id"
    t.index ["site_id"], name: "index_content_assets_on_site_id"
  end
  ...
  create_table "content_pages", force: :cascade do |t|
    ...
    t.index ["site_id"], name: "index_content_pages_on_site_id"
  ...
  create_table "table_content_blocks", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.string "markdown"
    t.datetime "created_at", precision: 6, null: false
