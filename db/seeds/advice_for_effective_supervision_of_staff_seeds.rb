...
markdown_for_advice_for_effective_communication_of_staff = <<-MARKDOWN_FOR_ADVICE_FOR_EFFECTIVE_SUPERVISION_OF_STAFF
...
advice_for_effective_communication_of_staff = {
  title: "Advice for effective communication of staff",
  markdown: markdown_for_advice_for_effective_communication_of_staff,
  description: "Advice for effective communication of staff",
  featured_alt_text: "Featured alt text",
  thumbnail_alt_text: "Thumbnail alt text",
}
advice_for_effective_communication_of_staff_page = Article.new advice_for_effective_communication_of_staff
advice_for_effective_communication_of_staff_page.featured_image.attach(io: File.open("spec/fixtures/sample.jpeg"), filename: "sample.jpeg", content_type: "image/jpeg")
advice_for_effective_communication_of_staff_page.thumbnail_image.attach(io: File.open("spec/fixtures/sample.jpeg"), filename: "sample.jpeg", content_type: "image/jpeg")
advice_for_effective_communication_of_staff_page.save!
