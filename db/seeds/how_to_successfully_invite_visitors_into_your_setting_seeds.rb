...
markdown_for_how_to_successfully_invite_visitors_into_your_setting = <<-MARKDOWN_FOR_HOW_TO_SUCCESSFULLY_INVITE
...
MARKDOWN_FOR_HOW_TO_SUCCESSFULLY_INVITE

how_to_successfully_invite_visitors_into_your_setting = {
  title: "How to successfully invite visitors into your setting",
  markdown: markdown_for_how_to_successfully_invite_visitors_into_your_setting,
  description: "How to successfully invite visitors into your setting"
}
how_to_successfully_invite_visitors_into_your_setting_page = Article.new how_to_successfully_invite_visitors_into_your_setting
how_to_successfully_invite_visitors_into_your_setting_page.save!
