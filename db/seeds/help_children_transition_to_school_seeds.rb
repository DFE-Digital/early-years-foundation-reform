...
markdown_for_help_children_transition = <<-MARKDOWN_FOR_HELP_CHILDREN_TRANSITION
...
MARKDOWN_FOR_HELP_CHILDREN_TRANSITION

help_children_transition = {
  title: "Help children transition to school",
  markdown: markdown_for_help_children_transition,
  description: "Help children transition to school"
}
help_children_transition_page = Article.new help_children_transition
help_children_transition_page.save!
