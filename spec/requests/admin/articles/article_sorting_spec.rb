...
RSpec.describe "Admin::ArticlesController#index sorting", type: :request do
  let!(:article_1) { create :article, :complete, :published, published_at: 1.minute.ago, description: "Support article" }
  let!(:article_2) { create :article, :complete, :published, published_at: 2.minutes.ago, description: "A typical support article" }
  let!(:article_3) { create :article, :complete, :published, published_at: 3.minutes.ago, description: "Beware a support article" }
  ...
  context "with draft articles and created date selected" do
    let!(:article_1) { create :article, :complete, description: "Support article" }
    let!(:article_2) { create :article, :complete, description: "A typical support article" }
    let!(:article_3) { create :article, :complete, description: "Beware a support article" }
  ...
  context "with unpublished articles and unpublished date selected" do
    let!(:article_1) { create :article, :complete, :unpublished, unpublished_at: 1.minute.ago, description: "Support article" }
    let!(:article_2) { create :article, :complete, :unpublished, unpublished_at: 3.minutes.ago, description: "A typical support article" }
    let!(:article_3) { create :article, :complete, :unpublished, unpublished_at: 2.minutes.ago, description: "Beware a support article" }
